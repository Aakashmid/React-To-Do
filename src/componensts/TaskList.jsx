  ...
  return (
    <>
      <div className="flex space-x-2 items-center lg:px-10 px-3 ">
        <p className="w-[40%] font-medium text-left ">Taskss</p>
          ...
          return (
            <li key={id} className=' w-full flex  lg:space-x-2 lg:items-start lg:px-10 px-3 my-1 '>
              ...
              <p id='' className="w-[20%] flex justify-center items-end space-x-2">
                <span className='' >
                  <input onChange={()=>handleCheckboxChange(id)} type="checkbox"  checked={completedTasks[id]} className=" w-4 h-4  text-blue-600 bg-gray-100 border-gray-300 rounded-lg" />
                </span>
                { completedTasks[id] &&
